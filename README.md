...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/villfa/composer-substitution-plugin?branch=main&svg=true)](https://ci.appveyor.com/project/villfa/composer-substitution-plugin)
